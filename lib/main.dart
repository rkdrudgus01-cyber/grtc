...
const String kAccessCode = 'grtc1234!';
const String kAccessSessionKey = 'grtc_access_granted';
...
class _LogAnalyzerState extends State<LogAnalyzer> {
  ...
  void initState() {
    super.initState();
    _accessGranted = web.window.sessionStorage.getItem(kAccessSessionKey) == '1';
  }
  ...
  void _verifyAccessCode() {
    final input = _accessCodeController.text.trim();
    if (input == kAccessCode) {
      web.window.sessionStorage.setItem(kAccessSessionKey, '1');
      setState(() {
        _accessGranted = true;
    ...
    setState(() {
      _accessErrorText = '접근 코드가 일치하지 않습니다.';
    });
  }
  ...
  String _doorBypassTargetLabel(List<String> targetCars) {
    return targetCars.isEmpty ? '대상 미확인' : targetCars.join(', ');
  }
        ...
        child: Container(
          ...
          decoration: const BoxDecoration(
            gradient: LinearGradient(
              colors: [Color(0xFFF4F8F5), Color(0xFFE8F1EC)],
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const Text(
                        '사내 사용자 확인 코드 입력',
                        textAlign: TextAlign.center,
                        style: TextStyle(fontSize: 14, color: Color(0xFF667A70)),
                      ),
                      ...
                      const SizedBox(height: 18),
                      const Text(
                        '※ 본 시스템은 운행기록 분석 보조도구이며, 외부 공유를 제한합니다.',
                        textAlign: TextAlign.center,
                        style: TextStyle(fontSize: 12, color: Color(0xFF6C7D75)),
                      ),
                    ],
                  ),
                ),
